(function (global, factory) {
  ...
  function () {
    function IQO(standard) {
      ...
      _defineProperty(this, "standard", 600);
    ...
    _createClass(IQO, [{
      ...
      value: function _drawImage(image, type, quality, scale) {
        ...
        return new _Promise(function (resolve) {
          var rate = image.width / image.height; // Optimize: 缩小体积以减小图片大小
      ...
      value: function compress(file, quality, scale) {
        ...
        return this._file2Image(url).then(function (image) {
          return _this2._drawImage(image, type, quality, scale).then(function (blob) {
            // test(blob, file)
